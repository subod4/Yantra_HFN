    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-[#6C9BCF] to-[#F4F4F4] dark:from-[#2E4F4F] dark:to-[#1A1A1A] py-8">
        <div className="container mx-auto px-4">
          ...
          <p className="text-center text-lg text-[#555555] dark:text-gray-400">
            {exercise}
          </p>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          {filteredExercises.map((exercise, index) => (
            ...
            >
              <div className="p-6">
                <h2 className="text-xl font-bold text-[#333333] dark:text-gray-200">
                  {exercise}
                </h2>
                <p className="mt-2 text-lg text-[#555555] dark:text-gray-400">
                  {exercises[exercise]}
                </p>
