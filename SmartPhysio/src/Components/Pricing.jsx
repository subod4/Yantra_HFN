...
function Pricing() {
  return (
    <div
      id="pricing"
      className="bg-gradient-to-br from-[#6C9BCF] to-[#F4F4F4] dark:from-[#2E4F4F] dark:to-[#1A1A1A]  py-16"
    >
      <div className="container mx-auto px-6 text-center">
        {/* Section Title */}
        <h2 className="text-4xl font-bold text-center bg-gradient-to-r from-[#FF6F61] to-[#FFD166] bg-clip-text text-transparent mb-10">
          SajiloRehab Pricing Plans
        </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mt-12">
          ...
          <div className="bg-white dark:bg-neutral-800 p-8 rounded-lg shadow-lg transform hover:scale-105 transition duration-300">
            ...
            <p className="text-5xl font-bold text-[#333333] dark:text-gray-200 mt-6">
              $0
              <span className="text-[#555555] dark:text-gray-400 text-lg">
                /Month
              </span>
            </p>
          ...
          <div className="bg-white dark:bg-neutral-800 p-8 rounded-lg shadow-lg transform hover:scale-105 transition duration-300">
            <h3 className="text-2xl font-bold bg-gradient-to-r from-[#FF6F61] to-[#FFD166] text-transparent bg-clip-text mb-4">
              Pro
              <span className="text-sm text-[#FF6F61] ml-2">
                (Most Popular)
              </span>
            </h3>
            <p className="text-5xl font-bold text-[#333333] dark:text-gray-200 mt-6">
